...
![jenkinsfile](/images/python-pkg-cicd/jenkinsfile.png)
...
![master](/images/python-pkg-cicd/master.gif)

그러면 위와 같이 GitHub에서 page가 빌드되고, 그와 동시에 package를 build 후 GitHub와 PyPI에 배포한다.

<img src="/images/python-pkg-cicd/pypi.png" alt="pypi" width="1000" />
...
![github-1](/images/python-pkg-cicd/github-1.png)
...
![github-2](/images/python-pkg-cicd/github-2.png)
...
![github-3](/images/python-pkg-cicd/github-3.png)
...
![jenkins-setup-1](/images/python-pkg-cicd/jenkins-setup-1.png)

Multibranch Pipeline으로 project를 생성한다.

![jenkins-setup-2](/images/python-pkg-cicd/jenkins-setup-2.png)
