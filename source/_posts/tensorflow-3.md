...
![mnist-1](/images/tensorflow-3/mnist-1.png)
...
![numeric-1](/images/tensorflow-3/numeric-1.png)
...
![neural-network](/images/tensorflow-3/neural-network.png)
![sigmoid](/images/tensorflow-3/sigmoid.png)

+ 가중치 `W`를 사용하여 입력 데이터 `X`의 가중치 합을 계산하고 오프셋 `b`를 더함
+ `0`또는 `1`의 결과로 만들기 위해 비선형 활성화 함수를 적용함(sigmoid function)

![neural-network](/images/tensorflow-3/neural-network.gif)
...
![mnist-2](/images/tensorflow-3/mnist-2.png)

+ 붉은 색은 음의 가중치를 나타내고 푸른색은 양의 가중치를 나타냄

![array](/images/tensorflow-3/array.gif)
...
![softmax](/images/tensorflow-3/softmax.png)
...
![data](/images/tensorflow-3/data.png)
...
![cross-entropy-error](/images/tensorflow-3/cross-entropy-error.png)
...
![results](/images/tensorflow-3/results.png)
***
